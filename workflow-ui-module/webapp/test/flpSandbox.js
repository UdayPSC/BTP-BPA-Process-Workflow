		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Start Order Review Workflow",
									"targetURL": "#comprhworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comprhworkflowuimodule-display": {
								"semanticObject": "comprhworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.prh.workflowuimodule",
									"url": sap.ui.require.toUrl("com/prh/workflowuimodule")
								}
							}
						}
					}
